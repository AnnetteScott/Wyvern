function tableGen(e){
    ...
    let rowCount = 97;
    let tableHTML = '';
    let projectWeekObj = projects[document.querySelector(".navName").innerHTML.replaceAll(" ", "_")]["time_sheet_weeks"][e.target.getAttribute('value')];
